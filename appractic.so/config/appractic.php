...
return [
    /*
    * This option controls the default authentication "guard" for the Appractic routes
    */
    'auth_guard' => env('APPRACTIC_AUTH_GUARD', 'web'),

    /*
    * If you use another model for users, you can change it here.
    */
    'user_model' => \Inovector\Appractic\Models\User::class,

    /*
     * Appractic will redirect unauthorized users to the route name specified here
     */
     ...
     */
    'disk' => env('APPRACTIC_DISK', 'public'),
     ...
     * If set to null, storage_path('appractic-media/temp') will be used.
     */
     ...
     * Define cache prefix
     */
    'cache_prefix' => env('APPRACTIC_CACHE_PREFIX', 'appractic'),

    /*
     * Define log channel
     * Captures connection errors with social networks or third parties used in Appractic in a separate channel.
     * Leave blank if you want to use Laravel's default log channel
     */
    'log_channel' => env('APPRACTIC_LOG_CHANNEL'),
