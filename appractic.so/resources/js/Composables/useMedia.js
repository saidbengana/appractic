...
const useMedia = (routeName = 'appractic.media.fetchUploads', routeParams = {}) => {
    ...
    const downloadExternal = (items, callback) => {
        ...
        axios.post(route('appractic.media.download', routeParams), {
            items,
    ...
    const deletePermanently = (items, callback) => {
        ...
        axios.delete(route('appractic.media.delete', routeParams), {
            data: {
                items
            }
        }).then(() => {
