...
const uploadFile = (file) => {
    ...
    return new Promise((resolve, reject) => {
        axios.post(route('appractic.media.upload'), formData)
...
<template>
    <div @dragenter.prevent="dragEnter = !isLoading"
         @drop.prevent="onDrop"
         @dragover.prevent
         :class="{'border-primary-400 bg-white': !dragEnter, 'border-primary-500 bg-primary-50': dragEnter}"
        ...
        <div class="relative flex flex-col justify-center">
            ...
            <PhotoIcon :class="{'text-primary-400': !dragEnter, 'text-primary-500': dragEnter}"
            ...
            <div class="text-sm text-primary-400 text-center">{{ mimeTypes.join(', ') }}</div>
        </div>
