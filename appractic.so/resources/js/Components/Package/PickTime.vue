        ...
        <template #body>
            <div v-if="show" class="pickTime flex flex-col">
                ...
                <div class="text-sm flex items-center justify-center mt-sm">
                    ...
                    <Link :href="route('appractic.settings.index')" v-tooltip="'Post will be scheduled according to this timezone. Click to update it.'"><ExclamationCircleIcon class="!w-4 !h-4"/></Link>
                </div>
