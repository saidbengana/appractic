...
use Inovector\Appractic\Integrations\Unsplash\Jobs\TriggerDownloadJob;
use Inovector\Appractic\MediaConversions\MediaImageResizeConversion;
use Inovector\Appractic\Support\File;
use Illuminate\Support\Facades\Http;
use Inovector\Appractic\Support\MediaUploader;
...
class MediaDownloadExternal extends FormRequest
{
    ...
    public function handle(): Collection
    {
        return collect($this->input('items'))->map(function ($item) {
            ...
            $media = MediaUploader::fromFile($file)->path("appractic/$now")->conversions([
