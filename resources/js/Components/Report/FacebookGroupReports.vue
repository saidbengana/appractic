...
const metrics = computed(() => [
    {
        title: 'Total Members',
        value: formatNumber(props.data.total_members),
        change: props.data.total_members_change,
        chart: props.data.total_members_chart
    },
    {
        title: 'Active Members',
        value: formatNumber(props.data.active_members),
        change: props.data.active_members_change,
        chart: props.data.active_members_chart
    }
]);
</script>
