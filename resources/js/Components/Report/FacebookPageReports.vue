...
const metrics = computed(() => [
    {
        title: 'Page Views',
        value: formatNumber(props.data.page_views),
        change: props.data.page_views_change,
        chart: props.data.page_views_chart
    },
    {
        title: 'Page Likes',
        value: formatNumber(props.data.page_likes),
        change: props.data.page_likes_change,
        chart: props.data.page_likes_chart
    },
    {
        title: 'Post Reach',
