<script setup>
import {startOfWeek, addWeeks, parseISO, subWeeks} from "date-fns";
...
const selectPrevious = () => {
    let newSelectedDate = startOfWeek(subWeeks(props.selectedDate, 1));
...
const selectNext = () => {
    let newSelectedDate = startOfWeek(addWeeks(props.selectedDate, 1));
    emit("dateSelected", newSelectedDate);
}
</script>
<template>
